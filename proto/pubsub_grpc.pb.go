...
type PubSubServiceClient interface {
	Publish(ctx context.Context, in *PubRequest, opts ...grpc.CallOption) (*Response, error)
...
func (c *pubSubServiceClient) Publish(ctx context.Context, in *PubRequest, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
...
type PubSubServiceServer interface {
	Publish(context.Context, *PubRequest) (*Response, error)
...
func (UnimplementedPubSubServiceServer) Publish(context.Context, *PubRequest) (*Response, error) {
