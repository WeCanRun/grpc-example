...
func RegisterPubSubServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server PubSubServiceServer) error {
	...
	mux.Handle("POST", pattern_PubSubService_Publish_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/proto.PubSubService/Publish", runtime.WithHTTPPathPattern("/api/v1/publish"))
		if err != nil {
...
func RegisterPubSubServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client PubSubServiceClient) error {
	...
	mux.Handle("POST", pattern_PubSubService_Publish_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/proto.PubSubService/Publish", runtime.WithHTTPPathPattern("/api/v1/publish"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_PubSubService_Subscribe_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/proto.PubSubService/Subscribe", runtime.WithHTTPPathPattern("/api/v1/subscribe"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_PubSubService_Publish_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"api", "v1", "publish"}, ""))

	pattern_PubSubService_Subscribe_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"api", "v1", "subscribe"}, ""))
)
